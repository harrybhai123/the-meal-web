let items = [
  ...
  },
  {
    ...
    MealThumb: "https://www.themealdb.com/images/media/meals/1529444113.jpg",
  },
  {
    id: 3,
    item: "Nasi lemak",
  ...
  },
  {
    ...
    MealThumb: "https://www.themealdb.com/images/media/meals/1529446352.jpg",
  },
  {
    id: 5,
    item: "Chicken Fajita Mac and Cheese",
    category: "Chicken",
    area: "American",
    instructions:
...
//   },
  ...
  },
  {
    ...
    MealThumb: "https://www.themealdb.com/images/media/meals/1550441882.jpg",
  },
  {
    id: 10,
...
const allMeal = () => {
  let mealItems = items[current];
  item.textContent = "Meal Name:- " + mealItems.item;
  category.textContent = "Meal Category:- " + mealItems.category;
  area.textContent = "Meal Area:- " + mealItems.area;
  instructions.innerHTML =
    "<strong> Meal instructions:- </strong>" + mealItems.instructions;
  img.src = mealItems.MealThumb;
  console.log(mealItems.item);
};

random.addEventListener("click", function () {
  current = Math.trunc(Math.random() * items.length);
  allMeal(current);
});
